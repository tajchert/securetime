...
import static pl.tajchert.securetime.protocol.RtConstants.MIN_SEED_LENGTH;
import static pl.tajchert.securetime.protocol.RtConstants.PUBKEY_LENGTH;
...
public final class RtEd25519 {
    ...
    public static final class Verifier {
        ...
        public Verifier(byte[] publicKeyBytes) throws InvalidKeyException {
            ...
            this.verifier = new EdDSAEngine(pl.tajchert.securetime.protocol.RtHashing.newSha512());
